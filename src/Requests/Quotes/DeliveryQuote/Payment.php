...
namespace LocalProtocol\Requests\Quotes\DeliveryQuote;

use LocalProtocol\Core\Attributes\Optional;
use LocalProtocol\Core\Concerns\SdkModel;
use LocalProtocol\Core\Contracts\BaseModel;
use LocalProtocol\Requests\Quotes\DeliveryQuote\Payment\Instrument;

/**
 * Payment handlers available for accepting this quote.
 *
 * @phpstan-import-type InstrumentShape from \LocalProtocol\Requests\Quotes\DeliveryQuote\Payment\Instrument
 *
