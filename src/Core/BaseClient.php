...
namespace LocalProtocol\Core;

use LocalProtocol\Core\Contracts\BasePage;
use LocalProtocol\Core\Contracts\BaseResponse;
use LocalProtocol\Core\Contracts\BaseStream;
...
use LocalProtocol\Core\Implementation\RawResponse;
